	...
	
{
	...
	public function init(){
		...
		$form =  new \Sigefor\Component\Form2([
			...
			'id'		=> $this->containerId,
			'panelId'	=> $this->id,
			'name'		=> \Sigefor\JasonFile::getNameJasonFile('/form/config', self::$patternJsonFile),
			'method'	=> $this->method,
			'mode'		=> 1,
			'userData'=> [],
	...
	private function load(){
		...
		$this->panel->id = 'gt-config-'.$this->id;
		$this->panel->innerHTML = 'gt-config-'.$this->id;
		$this->typeElement = 'GTConfig';
